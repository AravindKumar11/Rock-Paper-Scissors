...
# insert picture
user_label = Label(root, image=scissor_img, bg="brown")
comp_label = Label(root, image=scissor_img_comp, bg="brown")
...
# indicators
user_indicator = Label(root, font=50, text="USER", bg="brown", fg="white")
comp_indicator = Label(root, font=50, text="COMPUTER", bg="brown", fg="white")
user_indicator.grid(row=0, column=3)
comp_indicator.grid(row=0, column=1)

# messages
msg = Label(root, font=50, bg="brown", fg="white")
...
scissor = Button(root, width=20, height=2, text="SCISSOR",
                 bg="Orange", fg="white", command=lambda: updateChoice("scissor")).grid(row=2, column=3)
